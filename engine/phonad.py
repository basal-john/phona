...
SYSTEM_PROMPT = (
    ...
    "- A clumsy phrase is not an error. Punctuate it and leave the words, so 'announce this "
    "is in the team' becomes 'announce this in the team' and never 'make the team aware of "
    "it'. Reach for a different word only when the original is not English.\n"
